 ...
 * outside of the PaidCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the PaidCommand, and therefore we test only one of them.
...
public class PaidCommandParserTest {
    ...
    public void parse_validArgs_returnsPaidCommand() {
        assertParseSuccess(parser, "1", new PaidCommand(INDEX_FIRST_ORDER));
    }
